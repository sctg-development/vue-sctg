    ...
    <div class="-mx-3 flex">
      <div class="w-2/3 mx-3">
        <div class="mb-6 w-full">
          <img :src="getCloudinaryImg('web-design', 300).toURL()" alt="Web design" class="rounded-xl w-full" />
        </div>
      </div>
      <div class="w-1/3 mx-3">
        <div class="mb-6 w-full bg-slate-300 rounded-lg">
          <img :src="getCloudinaryImg('responsive-web-design', 200).toURL()" alt="Responsive web design"
            class="w-full" />
        </div>
        <div class="mb-6 w-full bs-slate-100">
          <img src="../../assets/img/html5-react-vue.svg" alt="collection" class="rounded-lg w-full" />
        </div>
      </div>
    </div>
