...
export async function onRequestPost(context) {
  ...
  let MailjetApi = { "statusText": "ERROR", "error-codes": "ERROR API" };
  if (hCaptchaSucess) {
    MailjetApi = await sendEmail({
  ...
  console.log('NAME: ' + name + ' EMAIL: ' + email + ' MESAGE: ' + message + ' Sitekey: ' + hCaptchaSitekey + ' hCaptchaStatus: ' + hCaptchaSucess + ' API: ' + MailjetApi.statusText);
  response_code.hCaptchaResponse = hCaptchaSucess;
  response_code.mailjetResponse = MailjetApi.statusText;
